        ...
        <div className="h-screen flex items-center">
            <div className="w-full flex justify-center">
                <div className="flex flex-col justify-center items-center lg:w-3/5 w-full p-3">
                    <input ref={idInput} type="text" className="w-2/3 bg-gatoroboto-100 text-gatoroboto-50 pb-1 pt-1 pr-2 pl-2 placeholder:text-gatoroboto-50 rounded-xl" placeholder="Paste in YouTube video id">
                    </input>
