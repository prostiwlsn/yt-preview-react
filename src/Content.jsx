        ...
        <div className="h-screen flex items-center">
            <div className="w-full flex justify-center">
                <div className="flex flex-col justify-center items-center lg:w-3/5 w-full p-3">
                    ...
                    <button onClick={() => console.log(inputValue)} className="w-1/6 bg-gatoroboto-100 text-gatoroboto-50 mt-2 p-3 rounded-3xl hover:bg-gatoroboto-50 hover:text-gatoroboto-100 hover:border-2 hover:border-gatoroboto-100 transition-all">
                        Download images
                    </button>
                </div>
            </div>
